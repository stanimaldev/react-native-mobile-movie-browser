https://docs.cs50.net/ocw/mobile/projects/2/project2.html
...
just run expo init, choose either blank or minimal, name it, enter.

Just install React 5 (latest stuff):
npm install @react-navigation/native

https://reactnavigation.org/docs/getting-started/

The problem could be that I'm using React 4 stuff with React 5 and it's doodoo. Old problems: 

For react navigation, must install react-native-gesture-handler

npm install @react-navigation/stack
https://reactnavigation.org/docs/stack-navigator/


+ the Search component's handleChange e.target.value isn't working! 
google: undefined is not an object (evaluating react native onchangetext target value
https://stackoverflow.com/questions/56278067/how-to-fix-undefined-is-not-an-object-on-setstate-in-react-native
